                ...
                <form class="form-horizontal" action="{{route('admin.discounts.store')}}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" max="99" min="1" name="percent" class="form-control" id="inputPassword3" placeholder="میزان تخفیف را وارد کنید" value="{{ old('percent') }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" name="expiration_time" class="form-control" id="inputPassword3" placeholder="زمان انقضا را وارد کنید" value="{{ old('expiration_time') }}">
                        </div>
